...
import { ChevronRightIcon, PlayIcon, ClockIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
    ...
    if (result.success) {
      return (
        <svg width="20" height="20" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          <path d="M25 30 L50 20 L75 30 L75 60 L50 80 L25 60 Z" fill="#10b981" stroke="#10b981" strokeWidth="2"/>
          <text x="50" y="52" textAnchor="middle" fill="#ffffff" fontFamily="Inter, sans-serif" fontSize="20" fontWeight="700">IOC</text>
        </svg>
      );
    } else {
