...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="hidden" data-deployment="v2.0.0-2025-01-08-18:30:00-UTC" data-commit="ioc-redesign" data-preview-update={Date.now()}></div>
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="mb-8">
              <div className="inline-block">
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
                  {/* Shield Background */}
                  ...
                  {/* Company name */}
                  {/* Text moved outside of SVG */}
                </svg>
              </div>
              <div className="mt-2">
                <h1 className="text-xl font-bold text-gray-900">FRAMEWORK</h1>
                <p className="text-sm text-gray-600">Intelligence Operations Center</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-60">
              ...
              <div className="h-[100px] w-[100px] mx-auto bg-gray-300 rounded"></div>
              <div className="h-[100px] w-[100px] mx-auto bg-gray-300 rounded"></div>
              <div className="h-[100px] w-[100px] mx-auto bg-gray-300 rounded"></div>
              <div className="h-[100px] w-[100px] mx-auto bg-gray-300 rounded"></div>
            </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Pricing section removed due to Supabase dependency */}
          <div className="text-center">
            <p className="text-gray-500 italic">Pricing section placeholder</p>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-4 right-4 bg-yellow-100 border border-yellow-300 rounded-lg px-4 py-2 shadow-lg">
        <p className="text-sm text-yellow-800">
          <strong>Dev Preview:</strong> Images resized to 100x100
        </p>
      </div>
    </div>
  );
