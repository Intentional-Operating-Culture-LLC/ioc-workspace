 ...
 */
export async function getOrganizationAssessments(organizationId, options = {}) {
  let query = supabase
    .from('assessments')
    .select(`
      *,
 ...
 */
export async function createAssessment(assessmentData, questions = []) {
  // Create assessment
 ...
 */
export async function addAssessmentQuestions(assessmentId, questions) {
 ...
 */
export async function reorderAssessmentQuestions(assessmentId, questionOrders) {
 ...
 */
export async function getAssessmentResponses(assessmentId, options = {}) {
  let query = supabase
 ...
 */
export async function getAssessmentResponse(responseId) {
  const { data, error } = await supabase
    .from('assessment_responses')
    .select(`
      *,
 ...
 */
export async function submitAssessmentResponse(assessmentId, respondentId, responses, options = {}) {
...
export async function getAssessmentStatistics(assessmentId) {
  ...
  Object.keys(scoreDistribution).forEach(dimension => {
    ...
    scoreDistribution[dimension].average = scores.reduce((a, b) => a + b, 0) / scores.length;
 ...
 */
export async function duplicateAssessment(assessmentId, newTitle) {
