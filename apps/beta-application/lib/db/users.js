...
export async function searchUsers(query, options = {}) {
  ...
  if (options.organizationId) {
    // This would need a join with user_organizations
 ...
 */
export async function inviteUser(email, invitedBy, organizationId = null, role = 'member') {
 ...
 */
export async function validateUserPassword(userId, password) {
